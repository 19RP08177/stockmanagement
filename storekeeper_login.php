    ...
    <div class="container" style="width:500px;">
            ...
            if(isset($_POST['login'])){
                ...
                if(empty($username)){
                    ...
                    try{
                        $sql=$connection->prepare("SELECT * FROM store_keeper WHERE username=:uname AND password=:upassword");
                        ...
                        if($sql->rowCount() > 0){
                            if($username==$row['username']){
                                if($password==$row['password']){
                                    ...
                                    header("refresh:2; storehome.php");
                                }else{
            ...
            ?> 
                <h5 align="center">WELCOME TO Store Keeper LOGIN FORM</h5> 
